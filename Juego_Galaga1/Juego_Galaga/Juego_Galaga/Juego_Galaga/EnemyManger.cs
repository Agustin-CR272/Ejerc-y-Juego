...
namespace Juego_Galaga.Managers
{
    public class EnemyManager
    {
        ...
        {
            int xPosicion = random.Next(0, 1920 - texturaEnemigos.Width);
            int yPosicion = -texturaEnemigos.Height;

            enemigos.Add(new Enemy(texturaEnemigos, new Vector2(xPosicion, yPosicion)));
        }
